              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-green-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Appelez le <strong>+33 5 54 54 34 66</strong> — réponse immédiate, prise en charge en moins de 10 minutes.</p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-600">Appelez directement le <strong>+33 5 54 54 34 66</strong> ou utilisez le formulaire en ligne. La réservation prend moins d&apos;une minute. Vous pouvez aussi vous présenter directement à la station taxi sur le parvis de la gare.</p>
            </div>
