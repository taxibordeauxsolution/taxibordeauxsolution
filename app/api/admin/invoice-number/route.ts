...
import { connectDB, Counter } from '@/app/lib/mongodb'
...
export async function POST(req: NextRequest) {
  ...
  if (counter.seq < 1100) {
    ...
    return NextResponse.json({ success: true, invoiceNumber: 1100 })
  }

  return NextResponse.json({ success: true, invoiceNumber: counter.seq })
}
