      ...
      <section className="py-20 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-10">
            <a href="tel:0667237822" className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all shadow-lg hover:shadow-xl">
              <Phone size={22} />
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 bg-white rounded-2xl p-6">
              ...
              <p className="text-gray-600">Appelez le <strong>06 67 23 78 22</strong> ou utilisez le formulaire de réservation en ligne. Indiquez votre numéro de vol — votre chauffeur suivra les horaires en temps réel et s&apos;adaptera à tout retard.</p>
            </div>
            ...
            <div className="border border-gray-200 bg-white rounded-2xl p-6">
              ...
              <p className="text-gray-600">La station taxi officielle est située au niveau extérieur du <strong>Hall A</strong>, en sortie des arrivées. Elle est signalisée. Vous pouvez aussi appeler le <strong>06 67 23 78 22</strong> pour une prise en charge immédiate.</p>
            </div>
          </div>
        </div>
      </section>
