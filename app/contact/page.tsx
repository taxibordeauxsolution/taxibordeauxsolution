            ...
            <div className="space-y-8">
              ...
              <div className="bg-green-50 rounded-xl border border-green-200 p-6">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-semibold text-green-800">✅ Système email activé</h4>
                </div>
                <p className="text-sm text-green-700">
                  Connexion API Resend active. Réception garantie des demandes de réservation dans votre boîte email.
                </p>
              </div>
            </div>
