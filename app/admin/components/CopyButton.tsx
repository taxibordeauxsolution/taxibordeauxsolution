...
export function CopyButton({ text, className = '' }: { text: string; className?: string }) {
  ...
  return (
    <button
      onClick={copy}
      className={`relative p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors text-slate-600 hover:text-slate-700 dark:hover:text-slate-300 ${className}`}
      title="Copier"
    >
