...
const ConfigPrixSchema = new mongoose.Schema({
  ...
  itineraireJour: { type: String, default: 'rapide' },
  itineraireNuit: { type: String, default: 'court' },
  ...
  tarifNuitMajoreActive:  { type: Boolean, default: false },
  tarifNuitMajoreSeuilKm: { type: Number, default: 20 },
  tarifNuitMajorePrixKm:  { type: Number, default: 4.00 },
  tarifJourMajoreActive:  { type: Boolean, default: false },
  tarifJourMajoreSeuilKm: { type: Number, default: 20 },
  tarifJourMajorePrixKm:  { type: Number, default: 3.00 },
